...
def get_files():
    ...
    # sets = ['basic/', 'real_cartoon/']

    fake_dir = bs_dir
    fake_nms = os.listdir(fake_dir)
    fake_nms = fake_nms[:5000]
    for nm in fake_nms:
    ...
    #         label_dogs.append(1)
    print('There are %d japanese cartoon \nThere are %d american cartoon' %(len(cats), len(dogs)))
