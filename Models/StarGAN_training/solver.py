...
class Solver(object):
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            Image_path = "/home/rongliang/CE7454_project/data/final_test/"
            Out_dir = "/home/rongliang/CE7454_project/final_results/starGAN_2/"
            ...
            for i in range(len(File_name)):                      
              ...
              Current_image_path = File_name[i]
              ...
              Generated_image = self.G(Current_image, c)
          
              save_image(self.denorm(Generated_image.cpu()), Out_dir + Current_image_path.split('/')[-1])
